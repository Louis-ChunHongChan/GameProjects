    ...
    var enemy = cc.Class({
      ...
      hit: function hit() {
        if (this.isHit) this.enemyState = State.attack; else {
          ...
          "attack" == window.hero.animation ? this.health-- : "attack2" == window.hero.animation ? this.health -= 2 : "attack3" == window.hero.animation ? this.health-- : "airborne" == window.hero.animation && this.health--;
        }
      },
      die: function die() {
